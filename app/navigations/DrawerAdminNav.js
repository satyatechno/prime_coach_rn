...
const DRAWER_ITEMS = [
  {
    id: 21,
    icon: require("../../assets/images/user-circle.png"),
    title: "Admin",
    screen: "Admin",
  },
  {
    id: 22,
    icon: require("../../assets/images/wistle.png"),
    title: "Coaches",
    screen: "Coaches",
  },
  {
...
export default DrawerAdminNav = createDrawerNavigator(
  {
    Home: Home,
    Admin: {
      screen: AdminStack,
    },
    Coaches: CoachesStackNav,
    TrainingPlan: {
