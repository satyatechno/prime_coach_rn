...
export class TeamEvent extends Component {
    ...
    try {
      const res = await standardPostApi(
        ...
        undefined,
        {
          ...
          calender_year: year,
          access_user_id:
            navigation.getParam("content").playerDetails.player?.id,
        },
        true
      );
      ...
      try {
        const res = await standardPostApi(
          ...
          undefined,
          {
            access_token: await AsyncStorage.getItem("@USER_ACCESS_TOKEN"),
            assigned_user_id:
              this.props.navigation.getParam("content").playerDetails.player
                ?.id,
            event_id: eventId,
  ...
  onViewEvent = (item) => {
    this.props?.navigation?.navigate("AddEvent", {
      ...
      userId:
        this.props.navigation.getParam("content").playerDetails.player?.id,
      onLoadData: this.onLoadData,
      event: item,
      isTeamEvent: item?.assigned_user === null,
    });
  };
  render() {
    const {
                ...
                <CustomButton
                  ...
                  onPress={() => {
                    this.props?.navigation?.navigate("AddEvent", {
                      date: selectedDate,
                      userId:
                        this.props.navigation.getParam("content").playerDetails
                          .player?.id,
                      onLoadData: this.onLoadData,
                    });
                  }}
...
// import { Toaster } from '../../../../../components/Toaster';
// import IconChev from 'react-native-vector-icons/FontAwesome5';
// export class CalendarWorkout extends Component {
//   state = {
//     selectedDate: moment().format('YYYY-MM-DD'),
//     markedDates: {},
//     selectedWorkout: [],
...
//           calender_month: month,
//           calender_year: year,
// access_user_id: navigation.getParam('content').playerDetails.player
//   ?.id,
//         },
//         true
//       );
...
//           {
//             access_token: await AsyncStorage.getItem('@USER_ACCESS_TOKEN'),
//             assigned_user_id: this.props.navigation.getParam('content')
...
//       selectedEvent,
//     } = this.state;
//     const PlayerData = this.props.navigation.getParam('content').playerDetails
//       .player;
//     const TeamData = this.props.navigation.getParam('content').playerDetails
//       .teamData;
//     const Role = this.props.navigation.getParam('content').playerDetails.role;
//     let todayDate = moment(
//       moment().format('YYYY-MM-DD'),
//       'YYYY-MM-DD'
//     ).toDate();
...
//               style={styles.calendar}
//               theme={{
//                 calendarBackground: Colors.BG_LIGHT,
//                 selectedDayBackgroundColor: Colors.INDIGO_COLOR,
//                 selectedDayTextColor: Colors.WHITE_COLOR,
//                 dayTextColor: Colors.INDIGO_COLOR,

//                 dotColor: Colors.SKY_COLOR,
//                 selectedDotColor: Colors.WHITE_COLOR,
//                 arrowColor: Colors.LIGHT_RED,
//                 disabledArrowColor: Colors.LIGHT_GREY,
//                 monthTextColor: Colors.WHITE_COLOR,
...
//                       <Text style={styles.workoutText}>No Workout</Text>
//                     ) : (
//                       <>
...
//                     )}
//                     {selectedEvent.length === 0 ? (
//                       <Text style={styles.workoutText}>No Events</Text>
//                     ) : (
//                       <>
//                         {selectedEvent.map((item, index) => (
//                           <View style={styles.viewWorkout}>
...
//                                 {' '}
//                                 (
//                                 {moment(item?.event_time, 'HH:mm:ss').format(
//                                   'hh:mm a'
//                                 )}
//                                 -
//                                 {moment(
...
//                             </Text>
//                             <Text
//                               style={{ color: Colors.WHITE_COLOR, padding: 10 }}
//                             >
//                               {item?.event_description}
//                             </Text>
//                             <TouchableOpacity
...
//                 noAnimation={true}
//               />
//               {Role == 'Assistant Coach' ? null : this.state.eventActionType ==
//                 'add' ? (
//                 <TouchableOpacity
//                   onPress={() => this.onAddEvent('add')}
//                   disabled={addEventLoading}
...
//                         Alert.alert(
//                           'Delete Event',
//                           'Are you sure you want to delete this system?\nThis is a team event and deleting this will remove it from all the team members.',
//                           [
//                             { text: 'Cancel' },
//                             {
//                               text: 'Yes',
