          ...
          <View>
            ...
            <TildView>
              <View style={{ padding: 15 }}>
                ...
                <Text style={styles.value}>{userProfile?.body_weight}</Text>
...
//     console.log('Devise state at ', deviceState?.userId);
...
//       <HamBurger onMenuPress={() => this.props.navigation.openDrawer()}>
//         <Spinnner
//           visible={this.state.logoutLoader}
//           loaderTxt={'Logging Out...'}
//         />
//         <View style={styles.container}>
//           <Text style={styles.profile}>{i18n.t('profile.profile')}</Text>
//           {this.renderSeparator()}
...
//                   >
//                     <View style={styles.mainRow}>
//                       <PrimeImage style={styles.icon} source={item.img} />
//                       <View style={styles.rowContainer}>
//                         <Text style={styles.text}>{item.title}</Text>
//                         <Icon
//                           name="chevron-right"
